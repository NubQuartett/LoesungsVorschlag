    ...
    private void setzeAnzuzeigendeMedien()
    {
        ...
        for (Medium medium : medienListe)
        {
        	...
        	if(_verleihService.istVorgemerkt(medium)){
	            ...
	            vormerker1 = _verleihService.get_vormerkkarten().get(medium).get_v1();
	            vormerker2 = _verleihService.get_vormerkkarten().get(medium).get_v2();
	            vormerker3 = _verleihService.get_vormerkkarten().get(medium).get_v3();
	        }
