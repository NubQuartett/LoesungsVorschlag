...
public interface VerleihService extends ObservableService
{
    ...
    /**
     * Kontrollier ob Kunde die Medien vormerken darf
     * 
     * @param kunde
     * @param medien
     * 
     * @return gibt true zurück wenn vormerken möglich ist, sonst false
     * 
     * @require kunde != null
     * @require medien != null 
     * @require kundeImBestand()
     * @require medienImBestand()
     * 
     * 
     */
    ...
    /**
     * Merkt für die Kunden die Medien vor
     * 
     * @param kunde
     * @param medien
     * 
    ...
    /**
     * Gibt alle Vormerkkarten der Klasse in einer Map zurück (Schlüssel ist das Medium)
     * 
     * @return die Map der Klasse in der alle Vormerkkarte gespeichert sind
     * 
     */
    Map<Medium,Vormerkkarte>get_vormerkkarten();
    
    /**
     * Kontrolliert ob ein Medium vorgemerkt ist
     * @param medium
     * @return
     * 
     * @require medium =! null
